...
tio.sendMessage(m.chat, { audio: { url: anu.result }, mimetype: 'audio/mpeg', fileName: `${anu.title}.mp3` }, { quoted: m })
break
case 'ytmp4':
...
break
		...
		let { pinterest } = require('./lib/scraper')
                ...
                let buttons = [{buttonId: `.waifu`, buttonText: {displayText: 'Next Photo'}, type: 1}]
                tio.sendMessage(m.chat, { image: { url: result, buttons: buttons, caption: `Result from ${text}`, footer: weem }, { quoted: m })
            }
            break
            case 'waifuu': {
		...
		let buttons = [
            ...
            case 'gcsearch': {
                ...
                tio.sendMessage(m.chat, { caption: teks, footer: esce}, { quoted: fkontak })
                })} catch (e) {
		        m.reply(mess.errmor)}
                }
                break
...
if(!q.startsWith("+")) return m.reply("Masukan kode negara contoh +628xx")
