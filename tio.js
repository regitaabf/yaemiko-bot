...
break
            ...
            case 'runtime': case 'tes': {
                ...
                tio.sendMessage(m.chat, { text: lowq }, {quoted: ftextt})
            	}
            break
...
break
        ...
        case 'menfes': case 'menfess': {
            ...
            let akhji = `Bsrhasil mengirim pesan rahasi ke @${mq1.split('@')[0]}`
            await tio.sendButtonText(m.chat, buttons, akhji, esce, m, {mentions: ments})
            }
            break
 ...
 *Media Url* : ${images.url}`,
      ...
      /**  case 'lirik': case 'lyrics': {
        ...
        let song = 'https://api.neoxr.my.id/api/lyric?q=${args[0]}=snbkpS'
        tio.sendMessage(m.chat, { caption: song.lirik, footer: weem}, { quoted : m })
}*/
...
case 'tiktok': case 'tt': case 'tiktoknowm': { 
 ...
 tio.sendMessage(m.chat, { video: { url: anu.result.video }, fileName: 'tiktok.mp4', mimetype: 'video/mp4' }, { quoted: ftextt })
 break
...
tio.sendMessage(m.chat, { text: api.result }, {quoted: fakestatus })
}
break
case'logout':{
...
*›* ${prefix}addprem
*›* ${prefix}delprem`
            let buttons = [{ buttonId: 'sc', buttonText: { displayText: 'Website Bot' }, type: 1 }]
