...
//Pembatas FUN===============================================
            ...
            let sloth =`[ *SLOT* ]\n------------------------\n\n🍒 : 🍌 : 🍇\n${somtoy}<=====\n🍇 : 🍌 : 🍒\n\n------------------------\n[ *SLOT* ]\n\nNote: jika 3 buah berjajaran maka anda menang!`
...
break
		...
		let urls = quoted.text.match(new RegExp(/(?:https?:\/\/)?(?:youtu\.be\/|(?:www\.|m\.)?youtube\.com\/(?:watch|v|embed|shorts)(?:\.php)?(?:\?.*v=|\/))([a-zA-Z0-9\_-]+)/, 'gi'))
            ...
            case 'pinterest': {
                ...
                tio.sendMessage(m.chat, { image: { url: result }, caption: 'Result from ${q}' }, { quoted: m })
            }
            break
            case 'waifu': {
            	m.reply(mess.wait)
...
case 'facebook': case 'fb': case 'fbdl': 
 ...
 tio.sendMessage(m.chat, { video: { url: anu.result.Normal_video }, fileName: 'facebook.mp4', mimetype: 'video/mp4' }, { quoted: ftextt })
/** break
case 'ig': 
case 'igdl': 
case 'instagramreel': 
...
var api = await fetchJson(`https://mfarels.my.id/api/openai?text=${text}`.trim())
tio.sendMessage(m.chat, { text: api.result }, { quoted: m })
}
break
case'logout':{
